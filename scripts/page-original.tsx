  ...
  return (
    <div className="h-screen overflow-hidden bg-background text-foreground flex flex-row" dir={lang === "ar" ? "rtl" : "ltr"}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* شريط علوي — responsive */}
        <div className="h-12 bg-card/80 border-b border-border flex items-center justify-between px-3 sm:px-4 backdrop-blur-sm">
          {/* Mobile: hamburger + logo + company info */}
          ...
          {/* Five quick-nav icons — always visible on any page */}
          <div className="flex items-center gap-1">
            {([
              ...
              <button
                ...
                className={`flex items-center justify-center w-8 h-8 rounded-lg transition-all min-h-[32px] min-w-[32px] ${
                  activeTab === item.id
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Button
              ...
              className="text-muted-foreground hover:text-destructive hover:bg-destructive/10 text-xs min-h-[44px] flex items-center gap-1.5 px-3 border-border"
