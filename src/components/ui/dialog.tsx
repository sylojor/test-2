  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border shadow-lg duration-200 sm:max-w-lg max-h-[90dvh] overflow-hidden",
          className
        )}
        {...props}
      >
        ...
        <div className="overflow-y-auto overscroll-contain px-6 pt-6 pb-6 min-h-0 max-h-[calc(90dvh-2rem)]">
          {children}
        </div>
      </DialogPrimitive.Content>
    </DialogPortal>
