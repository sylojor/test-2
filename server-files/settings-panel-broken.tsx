  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-w-3xl overflow-x-hidden">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">{isOwner ? (isArabic ? "إعدادات الذكاء الاصطناعي والشركة" : "AI & Company Settings") : (isArabic ? "إعدادات الشركة والاشتراك" : "Company & Subscription Settings")}</p>
      </div>

      {/* ============================================ */}
      {/* إعدادات الـ LLM — REMOVED FROM SUBSCRIBER */}
      {/* Controlled by platform owner via admin panel */}
      {/* ============================================ */}
      ...
      {/* LLM section removed — platform owner only */}
      ...
      {/* Payment section removed — platform owner only */}
